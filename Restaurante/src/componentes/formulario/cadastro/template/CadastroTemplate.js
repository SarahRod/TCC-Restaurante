                ...
                <div class=" container">
                    ...
                    <div class="row mt-4 mb-5">
                        <div class="col-12 col-md-4">
                            ...
                            <input class="mr-3" type="radio" name="imagem" style={{boxShadow: 'none'}} value={`${DOMINIO_IMG}`+ `${TEMPLATE_IMG_1}`}  onChange={e => this.atualizaCampo(e)}/>Imagem 01
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="card mb-3">
                                <img class="card-img-top" style={{height: 220 + 'px'}} src={`${DOMINIO_IMG}`+ `${TEMPLATE_IMG_2}`} alt="imagem Template 02"/>
                            </div>
                            <input class="mr-3" type="radio" name="imagem" style={{boxShadow: 'none'}} value={`${DOMINIO_IMG}`+ `${TEMPLATE_IMG_2}`}  onChange={e => this.atualizaCampo(e)}/>Imagem 02
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="card mb-3">
                            ...
                            <input class="mr-3" type="radio" style={{boxShadow: 'none'}} name="imagem" value={`${DOMINIO_IMG}`+ `${TEMPLATE_IMG_3}`} onChange={e => this.atualizaCampo(e)}/>Imagem 03
                        </div>
                    </div>
                    <div className="row">
                    <div className="col-2 ml-auto">
                        <div className="col col-sm col-md   col-lg">
                            <Link class="btn btn-success" onClick={e => this.cadastroTemplate(e)}>Finalizar</Link>
                            {/* onclik={this.cadastroTemplate()} */}
                            {/* to="/restaurante" */}
                        </div>
                    </div>
                    </div>
